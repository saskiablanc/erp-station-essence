...
const BddPanel = (() => {
  ...
  const SCHEMAS = {
    ...
    transaction_cce: {
      ...
      canDel: true,
      cols: [
        { f: "id_transaction", label: "id_transaction", w: "120px" },
        { f: "id_carte_CE", label: "id_carte_CE", w: "" },
      ],
      addFields: [
        {
      ...
      editFields: [{ f: "id_carte_CE", label: "id_carte_CE", type: "number" }],
      load: () => Requetes.bddGet("transaction_cce"),
      add: (d) => Requetes.bddPost("transaction_cce", d),
      update: (id, d) => Requetes.bddPut("transaction_cce", id, d),
      del: (id) => Requetes.bddDel("transaction_cce", id),
      rowKey: (r) => r.id_transaction,
      rowHtml: (r) => [esc(r.id_transaction), esc(r.id_carte_CE)],
    },
    ...
    validation_journee: {
      ...
      short: "Valid. Journée",
      key: "id_journee_validee",
      dataKey: "rows",
      canAdd: true,
      canEdit: true,
      canDel: true,
      cols: [
        { f: "id_journee_validee", label: "ID", w: "60px" },
        { f: "date_jour", label: "Date jour", w: "120px" },
        { f: "est_valide", label: "Validé", w: "80px" },
        { f: "date_validation", label: "Date validation", w: "" },
      ],
      addFields: [
        {
          id: "bdd-date_jour",
        ...
        {
          id: "bdd-date_validation",
          f: "date_validation",
          label: "Date validation",
          type: "text",
          ph: "2026-03-19 23:00:00",
        },
      ],
      editFields: [
        { f: "date_jour", label: "Date jour", type: "text" },
        { f: "est_valide", label: "Validé (0/1)", type: "number" },
        { f: "date_validation", label: "Date validation", type: "text" },
      ],
      load: () => Requetes.bddGet("validation_journee"),
      add: (d) => Requetes.bddPost("validation_journee", d),
      update: (id, d) => Requetes.bddPut("validation_journee", id, d),
      del: (id) => Requetes.bddDel("validation_journee", id),
      rowKey: (r) => r.id_journee_validee,
      rowHtml: (r) => [
        esc(r.id_journee_validee),
        esc(r.date_jour),
        bool(Number(r.est_valide) === 1),
        esc(r.date_validation),
      ],
    },
  };
