...
(() => {
  ...
  jour_fermeture: {
    ...
    cols: [
      ...
      { f: "recurrent", label: "Récurrent", w: "85px" },
    ],
    addFields: [
      {
    ...
    editFields: [
      ...
      { f: "recurrent", label: "Récurrent (0/1)", type: "number" },
    ],
  ...
  validation_transactions: {
    ...
    short: "Val. Tx",
    key: "id_validation_tx",
    dataKey: "rows",
    canAdd: true,
    canEdit: true,
    canDel: true,
    cols: [
      { f: "id_validation_tx", label: "ID", w: "60px" },
      { f: "date_jour", label: "Date", w: "110px" },
      { f: "est_valide", label: "Validé", w: "75px" },
    ...
    addFields: [
      ...
      },
      {
        ...
        type: "text",
        ph: "2026-03-19 23:50:00",
      },
    ],
    editFields: [
      { f: "date_jour", label: "Date", type: "text" },
      { f: "est_valide", label: "Validé (0/1)", type: "number" },
      { f: "date_validation", label: "Date validation", type: "text" },
    ],
    load: () => Requetes.bddGet("validation_transactions"),
    add: (d) => Requetes.bddPost("validation_transactions", d),
    update: (id, d) => Requetes.bddPut("validation_transactions", id, d),
    del: (id) => Requetes.bddDel("validation_transactions", id),
    rowKey: (r) => r.id_validation_tx,
    rowHtml: (r) => [
      esc(r.id_validation_tx),
      esc(r.date_jour),
      bool(r.est_valide),
  ...
  validation_incidents: {
    ...
    short: "Val. Inc.",
    key: "id_validation_inc",
    dataKey: "rows",
    canAdd: true,
    canEdit: true,
    canDel: true,
    cols: [
      { f: "id_validation_inc", label: "ID", w: "60px" },
      { f: "date_jour", label: "Date", w: "110px" },
      { f: "est_valide", label: "Validé", w: "75px" },
      { f: "date_validation", label: "Date validation", w: "" },
    ],
    ...
    load: () => Requetes.bddGet("validation_incidents"),
    add: (d) => Requetes.bddPost("validation_incidents", d),
    update: (id, d) => Requetes.bddPut("validation_incidents", id, d),
    del: (id) => Requetes.bddDel("validation_incidents", id),
    rowKey: (r) => r.id_validation_inc,
    rowHtml: (r) => [
      esc(r.id_validation_inc),
      esc(r.date_jour),
      bool(r.est_valide),
      esc(r.date_validation),
    ],
