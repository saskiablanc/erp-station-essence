...
--
-- Hôte : localhost
-- Généré le : jeu. 12 mars 2026 à 13:49
...
(2, 'En cours', '2026-03-10', '2026-03-14', 1),
...
--
ALTER TABLE `Reapprovisionnement`
  MODIFY `id_reappro` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `Stock`
  MODIFY `id_stock` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT pour la table `Transaction`
--
ALTER TABLE `Transaction`
  MODIFY `id_transaction` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT pour la table `TransactionEnergie`
--
ALTER TABLE `TransactionEnergie`
  MODIFY ` id_transaction_energie` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT pour la table `TransactionProduit`
--
ALTER TABLE `TransactionProduit`
  MODIFY `id_transaction_produit` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
